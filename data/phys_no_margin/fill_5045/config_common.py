...
config.matching.rp_R_1_F.x_min = 9.50
config.matching.rp_R_1_F.x_max = 14.50

config.alignment_y.rp_L_1_F.x_min = 8.50
config.alignment_y.rp_L_1_F.x_max = 12.50
config.alignment_y.rp_L_1_N.x_min = 8.50
config.alignment_y.rp_L_1_N.x_max = 12.00
config.alignment_y.rp_R_1_N.x_min = 6.00
config.alignment_y.rp_R_1_N.x_max = 12.00
config.alignment_y.rp_R_1_F.x_min = 6.00
config.alignment_y.rp_R_1_F.x_max = 12.00
