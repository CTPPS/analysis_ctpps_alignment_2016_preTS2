...
config.alignment_y.rp_L_1_F.x_min = 4.00
config.alignment_y.rp_L_1_F.x_max = 10.00
config.alignment_y.rp_L_1_N.x_min = 4.00
...
config.rel_alignment_x.rp_L_1_F.x_min = 4.00
config.rel_alignment_x.rp_L_1_F.x_max = -1.00
config.rel_alignment_x.rp_L_1_N.x_min = 4.00
