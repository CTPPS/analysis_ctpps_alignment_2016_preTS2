...
config.sector_45.cut_h_a = -0.992
config.sector_45.cut_h_c = -0.825
config.sector_45.cut_h_si = 0.200

#config.sector_45.cut_v_apply = False
config.sector_45.cut_v_a = -1.142
config.sector_45.cut_v_c = 0.100
config.sector_45.cut_v_si = 0.150

#config.sector_56.cut_h_apply = True
config.sector_56.cut_h_a = -0.971
config.sector_56.cut_h_c = 0.451
